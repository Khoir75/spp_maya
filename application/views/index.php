...
<body>
    ...
    <section class="main" id="main">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <h2>Aplikasi Pembayaran SPP Berbasis Web</h2>
                ...
                <div class="col-sm-6 right">
                    <div class="card m-n1">
                        <div class="card-body">
                            <h5 class="card-title text-center mb-2">Silahkan Masuk</h5>
            ...
            <div class="row text-center">
                <div class="col-md">
                    <ul class="nav mb-3">
                        ...
                        <li class="nav-item"><a href="https://www.instagram.com/" target="_blank"><i class="fab fa-instagram"></i></a></li>
